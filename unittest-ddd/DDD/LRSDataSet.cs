...
namespace SQLSpatialTools.UnitTests.DDD
{
    public class LRSDataSet
    {
        public class ClipGeometrySegmentData : BaseDataSet
        {
            ...
            public static readonly string SelectQuery = string.Format("SELECT [Id], [InputGeom], [StartMeasure], [EndMeasure], [ExpectedResult1] FROM [{0}];", TableName);
            public static readonly string InsertQuery = string.Format("INSERT INTO [{0}] ([InputGeom], [StartMeasure], [EndMeasure], [ExpectedResult1]) VALUES (N'[0]', [1], [2], N'[3]');", TableName);
        ...
        public class GetEndMeasureData : BaseDataSet
        {
            ...
            public static readonly string InsertQuery = string.Format("INSERT INTO [{0}] ([InputGeom], [ExpectedResult1]) VALUES (N'[0]', [1]);", TableName);
            public string GetTargetUpdateQuery(string fieldName, object fieldValue) { return GetTargetUpdateQuery(TableName, fieldName, fieldValue); }
        ...
        public class InterpolateBetweenGeomData : BaseDataSet
        {
            ...
            public static readonly string SelectQuery = string.Format("SELECT [Id], [InputGeom1], [InputGeom2], [Measure], [ExpectedResult1] FROM [{0}];", TableName);
            public static readonly string InsertQuery = string.Format("INSERT INTO [{0}] ([InputGeom1], [InputGeom2], [Measure], [ExpectedResult1]) VALUES (N'[0]', N'[1]', [2], N'[3]');", TableName);
            public string GetTargetUpdateQuery(string fieldName, object fieldValue) { return GetTargetUpdateQuery(TableName, fieldName, fieldValue); }
        ...
        public class IsConnectedData : BaseDataSet
        {
            ...
            public static readonly string SelectQuery = string.Format("SELECT [Id], [InputGeom1], [InputGeom2], [Tolerance], [ExpectedResult1] FROM [{0}];", TableName);
            public static readonly string InsertQuery = string.Format("INSERT INTO [{0}] ([InputGeom1], [InputGeom2], [Tolerance], [ExpectedResult1]) VALUES (N'[0]', N'[1]', [2], [3]);", TableName);
            public string GetTargetUpdateQuery(string fieldName, object fieldValue) { return GetTargetUpdateQuery(TableName, fieldName, fieldValue); }
        ...
        public class LocatePointAlongGeomData : BaseDataSet
        {
            ...
            public static readonly string SelectQuery = string.Format("SELECT [Id], [InputGeom], [Measure], [ExpectedResult1] FROM [{0}];", TableName);
            public static readonly string InsertQuery = string.Format("INSERT INTO [{0}] ([InputGeom], [Measure], [ExpectedResult1]) VALUES (N'[0]', N'[1]', N'[2]');", TableName);
            public string GetTargetUpdateQuery(string fieldName, object fieldValue) { return GetTargetUpdateQuery(TableName, fieldName, fieldValue); }
        ...
        public class MergeGeometrySegmentsData : BaseDataSet
        {
            ...
            public static readonly string SelectQuery = string.Format("SELECT [Id], [InputGeom1], [InputGeom2], [ExpectedResult1], [Tolerance] FROM [{0}];", TableName);
            public static readonly string InsertQuery = string.Format("INSERT INTO [{0}] ([InputGeom1], [InputGeom2], [ExpectedResult1], [Tolerance]) VALUES (N'[0]', N'[1]', N'[2]', [3]);", TableName);
            public string GetTargetUpdateQuery(string fieldName, object fieldValue) { return GetTargetUpdateQuery(TableName, fieldName, fieldValue); }
        ...
        public class SplitGeometrySegmentData : BaseDataSet
        {
            ...
            public static readonly string SelectQuery = string.Format("SELECT [Id], [InputGeom], [Measure], [ExpectedResult1], [ExpectedResult2] FROM [{0}];", TableName);
            public static readonly string InsertQuery = string.Format("INSERT INTO [{0}] ([InputGeom], [Measure], [ExpectedResult1], [ExpectedResult2]) VALUES (N'[0]', [1], N'[2]', N'[3]');", TableName);
            public string GetTargetUpdateQuery(string fieldName, object fieldValue) { return GetTargetUpdateQuery(TableName, fieldName, fieldValue); }
