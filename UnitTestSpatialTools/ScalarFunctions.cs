...
namespace SpatialTools.UnitTest
{
    ...
    public class ScalarFunctions
    {
        ...
        public void LocateMAlongGeom_Test()
        {
            ...
            var sqlgeom = LRS.Geometry.LocateMeasureAlongGeometry(geom, distance);
        ...
        {
            var geom1 = SqlGeometry.STPointFromText(new SqlChars("POINT(0 0 0 0)"), General.DEFAULT_SRID);
            var geom2 = SqlGeometry.STPointFromText(new SqlChars("POINT(10 0 0 10)"), General.DEFAULT_SRID);
            var returnPoint = SqlGeometry.STPointFromText(new SqlChars("POINT (5 0 NULL 5)"), General.DEFAULT_SRID);
            var distance = 5;
        ...
        {
            var geom = SqlGeometry.STLineFromText(new SqlChars("LINESTRING (10 1 10 100, 15 5 10 150 )"), General.DEFAULT_SRID); //
            ...
            populatedGeometry = LRS.Geometry.PopulateGeometryMeasures(geom, updatedStartMeasure, updatedEndMeasure);
        ...
        public static void MergeGeometrySegments_LineString_Test()
        {
            ...
            var resultantGeom = LRS.Geometry.MergeGeometrySegments(geom1, geom2);
        ...
        public static void MergeGeometrySegments_Polygon_Test()
        {
            ...
            var geom1 = SqlGeometry.STPolyFromText(new SqlChars(new SqlString(sqlstring)), General.DEFAULT_SRID).MakeValid();
            x = rand.Next(500, 1500);
            y = x * 2;
            sqlstring = "POLYGON ((" + x + " " + x + " " + z + " " + m + ", " + y + " " + x + " " + z + " " + m + ", " + y + " " + y + " " + z + " " + m + ", " + x + " " + x + " " + z + " " + m + "))";
            var geom2 = SqlGeometry.STPolyFromText(new SqlChars(new SqlString(sqlstring)), General.DEFAULT_SRID).MakeValid();
            var resultantGeom = LRS.Geometry.MergeGeometrySegments(geom1, geom2);
            /*
        ...
        public static void SplitGeometrySegment_Valid_LineSegment_Test()
        {
            ...
            LRS.Geometry.SplitGeometrySegment(lineSegment, 6, out var lineSegment3, out var lineSegment4);
        ...
        public static void SplitGeometrySegment_Invalid_LineSegment_Test()
        {
            ...
            try
            {
                LRS.Geometry.SplitGeometrySegment(lineSegment, 2, out var lineSegment1, out var lineSegment2);
        ...
        public static void SplitGeometrySegment_MultiLineSegment_Test()
        {
            ...
            var lineSegment = SqlGeometry.STMLineFromText(new SqlChars(new SqlString("MULTILINESTRING((1 1 NULL " + startingPointMValue + ", 2 15 NULL " + endingPointMValue + "))")), General.DEFAULT_SRID);
            LRS.Geometry.SplitGeometrySegment(lineSegment, splitPointMValue, out var lineSegment3, out var lineSegment4);
        ...
        public static void ReverseLineString_Test()
        {
            ...
            int endPtX = 5;
            int endPtY = 5;
            var lineSegment = SqlGeometry.STLineFromText(new SqlChars(new SqlString("LINESTRING(" + startPtX + " " + startPtY + "   0 0, " + endPtX + " " + endPtY + " 0 0)")), General.DEFAULT_SRID);
            var reversedLineSegment = LRS.Geometry.ReverseLinearGeometry(lineSegment);
        ...
        public static void IsConnectedGeomLineSegments_Test()
        {
            ...
            double tolerance = 0;
            bool result = (bool)General.IsConnectedGeomSegments(g1, g2, tolerance);
            Assert.IsTrue(result);
            
            g1 = "LINESTRING(0 0 0 0, 1 1 0 0, 3 4 0 0, 5.5 5 0 0)".GetGeom();
            g2 = "LINESTRING(2 2 0 0, 0 0 0 0)".GetGeom();
            tolerance = 0;
            result = (bool)General.IsConnectedGeomSegments(g1, g2, tolerance);
            Assert.IsTrue(result);
